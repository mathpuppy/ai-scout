...
- 第二份产物 **`reports/agent-tech-flash-<date>.md`（群发速览）**：自足的要点概览，读者不看周报即可掌握全部核心要点——全部选题按结论标签分三组，详略两档：导入条目 3 行（标题带日期/版本 + 是什么 + 对我们），观望/仅记录各一行；无表格、正文不内嵌链接、零新增事实。默认落盘人工粘贴，webhook 推送见设计原则 5。
